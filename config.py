...
# ... vos variables d'environnement (USER, PASSWORD, HOST, PORT, etc.) ...

# --- Format ConnectorX / Polars URI ---
...
# Variable d'administration connectée à la BDD système 'postgres' pour DROP/CREATE DATABASE
ADMIN_POSTGRES_SQLALCHEMY_URI = f"postgresql+psycopg2://{DATA_BASE_SOURCE_A_USER}:{DATA_BASE_SOURCE_A_PASSWORD}@{DATA_BASE_SOURCE_A_HOST}:{DATA_BASE_SOURCE_A_PORT}/postgres"
